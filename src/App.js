    ...
    <>
      <section className='box mx-auto flex flex-col bg-gradient-to-b from-slate-100 to-slate-300 border border-zinc-300 shadow-gray-400 shadow-2xl md:rounded-xl overflow-hidden z-10'>
        ...
        <div className='flex min-w-full flex-col lg:flex-row'>
          ...
          {/* hl7 selected choice */}
          <section className='relative p-2 mb-2 rounded-xl min-w-ful md:min-w-fit overflow-hidden min-h-full md:h-auto z-10'>
            {/* hl2 choice part */}
            <Choice choice={choice} />
            <div className='absolute -bottom-28 -right-10 w-96 h-96 md:w-30r md:h-30r  rounded-full bg-gradient-to-bl from-[#12c2e9] via-[#c471ed] to-[#f64f59] opacity-70 -z-10'></div>
            {/*hl6 choice preset  */}
